package io.github.magisk317.smscode.core.hook.notification

object NotificationHookConst {
    private fun resolveNamespace(): String = io.github.magisk317.smscode.core.runtime.CoreRuntime.access.actionNamespace
